...
export default function ServiceCard({ service }) {
  ...
  return (
    <article className="card group min-w-0 flex h-full flex-col p-5 interactive-lift">
      <div className="mb-5 flex items-start justify-between gap-4">
        <span className="grid size-12 shrink-0 place-items-center rounded-2xl bg-pink-50 text-pink-700"><Icon size={24}/></span>
