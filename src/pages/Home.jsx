...
export default function Home(){
  return <>
    <section className="hero-grid overflow-hidden bg-gradient-to-b from-pink-50 via-white to-slate-50">
      <div className="container-app grid lg:min-h-[650px] items-center gap-8 py-9 sm:gap-12 sm:py-16 lg:grid-cols-[minmax(0,1.05fr)_minmax(0,.95fr)]">
        <div className="motion-rise">
          <div className="motion-rise motion-delay-1 mb-6 inline-flex items-center gap-2 rounded-full border border-pink-200 bg-white px-3 py-2 text-xs font-semibold sm:text-sm text-pink-800"><BadgeCheck size={16}/> Layanan keperawatan profesional di rumah</div>
          <h1 className="motion-rise motion-delay-1 max-w-3xl text-[2rem] font-black sm:text-4xl leading-tight tracking-[-0.04em] text-slate-950 sm:text-6xl">Perawatan profesional, <span className="text-pink-700">datang ke rumah.</span></h1>
          <p className="motion-rise motion-delay-2 mt-6 max-w-2xl text-base leading-7 sm:text-lg sm:leading-8 text-slate-600">Booking layanan keperawatan menjadi lebih simpel—pilih layanan, isi kondisi pasien, tentukan jadwal, lalu tunggu konfirmasi Jihan's HomeCare.</p>
        ...
        <div className="motion-rise motion-delay-2 relative">
          <div className="card interactive-lift relative overflow-hidden p-4 shadow-soft sm:p-8">
